		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GL Posting App",
									"targetURL": "#sdaglpostingapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdaglpostingapp2-display": {
								"semanticObject": "sdaglpostingapp2",
								"action": "display",
								"description": "GL Posting App",
								"title": "GL Posting App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sda.glpostingapp2",
									"url": sap.ui.require.toUrl("sda/glpostingapp2")
								}
							}
						}
					}
